...
public class AnalogClock_qi extends View {
	...
	public void InitResource(int width, int height) {
		...
		Log.i("AnalogClock",
				"mDialDrawable width " + mDialDrawable.getIntrinsicWidth()
						+ "mDialDrawable height "
						+ mDialDrawable.getIntrinsicHeight());
	...
	public Bitmap zoomBitmap(Bitmap bitmap, int width, int height) {
		...
		Log.i("AnalogClock", "newbitmap width " + newbmp.getWidth()
				+ "newbitmap height " + newbmp.getHeight());
		return newbmp;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (changed) {
			...
			// hourHand.setBounds(x - (w / 2), y * (3/5), x + (w / 2), y
			// +(y*(2/5)));
			// hourHand.setBounds(x * (3/5),y * (3/5), x + (x*(2/5)), y
			// +(y*(2/5)));
		}
		...
		if (changed) {
			...
			// minuteHand.setBounds(x - (w / 2), y / 2, x + (w / 2), y +
			// (y*(1/2)));
