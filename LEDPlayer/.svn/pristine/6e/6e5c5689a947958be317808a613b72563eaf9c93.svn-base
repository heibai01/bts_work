...
public class FileMD5 
{
    ...
    /*public static void main(String[] args) throws IOException {
        ...
        File file = new File("E:\\资源\\LED显示屏播放测试节目11G\\5-.avi");

        String md5 = getFileMD5String(file);
        /* //文件名不同，内容相同；
        File file2 = new File("E:\\资源\\LED显示屏播放测试节目11G\\5-.avi");
        String md52= getFileMD5String(file2);

       //文件名不同，内容不同；
        File file3 = new File("E:\\资源\\LED显示屏播放测试节目11G\\6.jpg");
        String md53= getFileMD5String(file3);

        //测试压缩包
        File fileZip = new File("E:\\资源\\LED显示屏播放测试节目11G\\02c.swf");
        String md5Zip= getFileMD5String(fileZip);

        //测试压缩包
        File fileZip2 = new File("E:\\资源\\LED显示屏播放测试节目11G\\01c.swf");
